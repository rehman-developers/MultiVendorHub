@extends('layouts.masterlayout')
 ...
 <h2 class="text-2xl font-semibold mb-4">Main Content</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-white p-4 shadow rounded-lg">
            <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80" alt="Food Dish" class="w-full h-48 object-cover rounded-t-lg">
            <p class="mt-2">Food Dish</p>
        </div>
    </div>
